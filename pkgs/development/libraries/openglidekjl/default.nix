{ autoconf, automake, fetchFromGitHub, lib, libGL, libGLU, libtool, libX11, mesa
, stdenv }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ automake autoconf libtool libGL ];
  ...
  meta = with lib; {
    description =
      "OpenGLide fork optimized for QEMU (Supports Glide2x & Glide3x)";
